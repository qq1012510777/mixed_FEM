function [coordinate element dirichlet dirichlet_att Neumann] = Trapezoidal_mesh(min_edge, max_edge)

    model = createpde;

    Trapezoidal_x = [0, 80, 80, 0];
    Trapezoidal_y = [0, -70, 120, 50];

    R1 = [3, 4, Trapezoidal_x, Trapezoidal_y]';
    gm = [R1];
    sf = 'R1';
    ns = char('R1');
    ns = ns';
    ...
    for i = 1:size(element, 1)
        ...
        for j = 1:3
            ...
            if (x1 == Trapezoidal_x(2) && x2 == Trapezoidal_x(2))
                d1 = d1 + 1;
    ...
    p1 = [Trapezoidal_x(3), Trapezoidal_y(3)];
    p2 = [Trapezoidal_x(4), Trapezoidal_y(4)];
